export const content = {
  en: {
    ...
    reviews: {
      ...
      writeHere: "Write your review here...",
      ...
      you: "You",
      edited: "(Edited)",
      deleteConfirm: "Delete this review forever?",
      reviewsCount: "reviews"
    },
    booking: {
      experienceMewar: "Experience Mewar",
      stage: "Stage",
      of: "of",
      arrivalQuestion: "When shall we prepare for your arrival?",
      guestsParty: "Guests in your party",
      continueJourney: "Continue Journey",
      royalChauffeur: "The Royal Chauffeur",
      grandAccommodations: "Grand Accommodations",
      heritageHistorian: "Heritage Historian",
      totalEstimate: "Total Estimate",
      goBack: "Go Back",
      royalSummary: "Your Royal Summary",
      transport: "Transport",
      stays: "Stays",
      guide: "Guide",
      ...
      options: {
        ...
        historyScholar: "History Scholar",
  ...
  hi: {
    ...
    reviews: {
      visitorReviews: "आगंतुक समीक्षाएँ",
      ...
      valuableFeedback: "आपकी बहुमूल्य प्रतिक्रिया के लिए धन्यवाद!",
      yourRating: "आपकी रेटिंग",
      yourName: "आपका नाम (वैकल्पिक)",
      writeHere: "अपनी समीक्षा यहाँ लिखें...",
      ...
      you: "आप",
      edited: "(संपादित)",
      deleteConfirm: "क्या आप इस समीक्षा को हमेशा के लिए हटाना चाहते हैं?",
      reviewsCount: "समीक्षाएं"
    },
    booking: {
      experienceMewar: "मेवाड़ का अनुभव करें",
      stage: "चरण",
      of: "का",
      arrivalQuestion: "हमें आपके आगमन की तैयारी कब करनी चाहिए?",
      guestsParty: "आपके समूह में मेहमान",
      continueJourney: "यात्रा जारी रखें",
      royalChauffeur: "शाही ड्राइवर",
      grandAccommodations: "शानदार आवास",
      heritageHistorian: "विरासत इतिहासकार",
      totalEstimate: "कुल अनुमान",
      goBack: "वापस जाएं",
      royalSummary: "आपका शाही सारांश",
      transport: "परिवहन",
      stays: "रुकना",
      guide: "गाइड",
      payOnArrival: "आगमन पर भुगतान",
      fullName: "पूरा नाम",
      whatsappNumber: "व्हाट्सएप नंबर",
      finalizeBooking: "बुकिंग पूरी करें",
      selectOne: "एक चुनें",
      options: {
